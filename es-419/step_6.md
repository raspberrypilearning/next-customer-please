...
Cada proyecto de ejemplo en la [Introducción](.) tiene un enlace 'Ver adentro' para que puedas abrir el proyecto en Scratch y mirar el código para obtener ideas y ver cómo funcionan. Puedes 'Ver el interior' de los proyectos de ejemplo para ver cómo funcionan.
