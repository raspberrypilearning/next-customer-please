...
افتح [مشروع Scratch جديد](http://rpf.io/scratch-new){: target = "_ blank"} وانظر إلى مجموعة الكائنات والخلفيات التي يمكنك استخدامها. Spend some time thinking about your shop idea.
