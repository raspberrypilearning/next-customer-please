...
Odpověz na tři otázky. Máš tu tipy co tě dovedou ke správné odpovědi.
...
Ano, to je správná odpověď. You need to `set`{:class="block3variables"} the `total`{:class="block3variables"} to `0` after each customer pays.
