...
What is your shop idea? Může to být něco opravdového, oblíbené knižky nebo filmu, nebo něco úplně jiného.
</div>
<div>
...
Vytvořte [nový projekt Scratch](http://rpf.io/scratch-new){:target="_blank"} a podívejte se na řadu postav a pozadí, které můžete použít. Spend some time thinking about your shop idea.
